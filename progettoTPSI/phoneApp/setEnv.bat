...
SET ANDROID_SDK_ROOT=C:\Users\Mia\AppData\Local\Android\Sdk


SET PATH=%PATH%;C:\Program Files\Java\jdk1.8.0_311\bin;
SET PATH=%PATH%;C:\Users\Mia\AppData\Local\Android\Sdk\tools;
SET PATH=%PATH%;C:\Users\Mia\AppData\Local\Android\Sdk\platform-tools;

REM percorso GRADLE (copiare dai settings di Android Studio)
SET PATH=%PATH%;C:\Users\Mia\.gradle\wrapper\dists\gradle-7.2-bin\2dnblmf4td7x66yl1d74lt32g\gradle-7.2\bin;
